            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="art_info">
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="sm" name="art_tags">
                    ...
                    <tr>
                        <th></th>
                        <td>
                            <img src="" alt="" id="art_img_show" style="max-width: 350px;max-height: 100px;">
                        </td>
                    </tr>
                    <tr>
                        <th><i class=""></i>文章内容：</th>
                        <td>
                            <script id="editor" name="art_content" value="{{old('art_content')}}" style="width:700px;height:300px;"></script>
                            <script>
                    ...
                    <tr>
                        <th>浏览次数</th>
                        <td>
                            <input type="text" class="sm" name="art_view" value="0">
