@extends('admin.app')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; <a href="{{url('admin/article')}}">分类管理</a> &raquo; 分类列表
    </div>
@if(session('ok'))
                    ...
                    @foreach($data as $v)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:;" onclick="toDelete({{$v->cate_id}});">删除</a>
                            </td>
                        </tr>
                    @endforeach
                </table>
