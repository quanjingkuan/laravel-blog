            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <select name="cate_pid">
                                ...
                                @foreach($data as $p)
                                <option value="{{$p->cate_id}}" @if($p->cate_id == $cate->cate_pid)selected="selected"@endif>{{$p->cate_name}}</option>
                                @endforeach
                            </select>
                    ...
                    <tr>
                        <th>查看次数</th>
                        <td>
                            <input type="text" class="sm" name="cate_view" value="{{$cate->cate_view}}" />
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="cate_keywoed" value="{{$cate->cate_keywoed}}">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="cate_desction" value="{{$cate->cate_desition}}">
                            <span><i class="fa fa-exclamation-circle yellow"></i>seo</span>
                        </td>
                    </tr>
                    <tr>
