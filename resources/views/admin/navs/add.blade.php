...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="#">导航管理</a> &raquo;
    </div>
    <!--面包屑导航 结束-->
	...
	<div class="result_wrap">
        ...
        <div class="result_content">
            <div class="short_wrap">
                <a href="{{url('admin/nav')}}"><i class="fa fa-recycle"></i>返回列表</a>
            </div>
        </div>
    </div>
    <!--结果集标题与导航组件 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="nav_url" value="">
